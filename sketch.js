...
function setup(){
 ...
 // fall.scale=2;
  ...
  spider.addImage("spidey",deadImage);
  spider.scale=0.3;
  ...
  object16=createSprite(215,1585,90,40);
  ...
  death=createSprite(10000,10000,30,30);
  death.addImage("corpes",deadImage);
  death.scale=0.1;
...
if(car.isTouching(dream)&&tears<5&&tears>3){
  console.log("Qay-Dad,what are you doing?");
  console.log("Dad-The race is where you end :/");
  tears =5;
}
if(Imposter.isTouching(dream)&&tears<6&&tears>4){
  console.log("Qay-Aviana,thoson is acting a bit strange");
  console.log("Aviana-The task is electric");
  tears =6;
}
if(angry.isTouching(dream)&&tears<7&&tears>5){
  console.log("Qay-Mom,dad and Aviana are acting different??");
  console.log("Amy-The eggs are where smell makes you angry!");
  tears =7;
}
if(brother.isTouching(dream)&&tears<8&&tears>6){
  console.log("Qay-Jack...noooooooo");
  console.log("Jack-the oxygen is where is life");
  tears =8;
  pain=1;
}
if(brother.isTouching(dream)&&pain<2&&pain>0){
  console.log("Jack-You can save me");
  console.log("Qay started crying *~* ");
  pain=2;
}
if(pain>1&&pain<3){
  death.position.x=355;
  death.position.y=1000;
  angry.position.x=10000;
  Imposter.position.x=10000;
  car.position.x=10000;
  trex.position.x=10000;
}
if(death.isTouching(dream)&&pain>1&&pain<3){
  console.log("You can save us");
  console.log("Qay fainted +_+");
  pain=3;
}
dream.collide(wall1);
dream.collide(wall2);
